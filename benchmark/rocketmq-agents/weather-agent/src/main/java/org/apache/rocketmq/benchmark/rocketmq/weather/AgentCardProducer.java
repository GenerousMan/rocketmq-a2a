...
/**
 * 天气Agent Card配置 - 描述Agent的能力和技能 (Mock版)
 */
@ApplicationScoped
public class AgentCardProducer {
    ...
    private static final String BIZ_TOPIC = System.getProperty("bizTopic", "WeatherAgentTask");
